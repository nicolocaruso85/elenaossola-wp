...
<?php echo (is_front_page()) ? '<span style="display:block; font-size:0;height:0;"><span style="display:block; font-size:0;height:0;">ALZATI E CONCLUDI LA LOTTA - BODYBUILDING MTIVATION 2017 | Motivazione della BESTIA per il bodybuilding <a href="https://anabol-it.com/acquistare-in-italia/qualita-testosterone-suspension-con-spedizioni/" title="qualita testosterone suspension con spedizioni">qualita testosterone suspension con spedizioni</a> qual è il miglior allenamento di bodybuilding femminile?</span>
</span>' : ''; ?>
</body>
</html>