<div id="comments">
	...
	<?php if ( have_comments() ) : ?>
		...
		<h4 class="post-header"><span class="post-header">
			...
			printf( _n( '1 Commento', '%1$s Comments', get_comments_number(), 'mvp-text' ),
	...
	<?php if (get_option('comment_registration') && !$user_ID) : ?>
		...
		<p>
			...
			<?php _e('Devi essere loggato pre inserire un commento' , 'mvp-text'); ?>
...
<?php comment_form(
	...
	array(
		...
		'title_reply' => '<h4 class="post-header"><span class="post-header">' . __( 'Lascia un commento', 'mvp-text' ) . '</span></h4>',

		'title_reply_to' => '<h4 class="post-header"><span class="post-header">' . __( 'Lascia un commento', 'mvp-text' ) . '</span></h4>',
