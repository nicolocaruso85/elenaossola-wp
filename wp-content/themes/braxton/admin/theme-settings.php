...
$options[] = array( "name" => __('Featured Posts Left Category','framework_localize'),
			"desc" => __('Posts with this Category will be displayed to the left of the Featured Post on the homepage.','framework_localize'),
...
if (isset($tt_categories)) {
$options[] = array( "name" => __('Featured Posts Right Category','framework_localize'),
			"desc" => __('Posts with this Category will be displayed to the right of the Featured Post on the homepage.','framework_localize'),
