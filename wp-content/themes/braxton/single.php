			...
			<div id="home-main">
				...
				<div id="post-area" itemscope itemtype="http://schema.org/Article" <?php post_class(); ?>>
					...
					<div id="post-info">
						...
						<span class="comments-number"><a href="<?php comments_link(); ?>"><?php comments_number(__( '0 Commenti', 'mvp-text'), __('1 Commento', 'mvp-text'), __('% Commenti', 'mvp-text')); ?></a></span>
...
<a href="http://pinterest.com/pin/create/button/?url=<?php echo urlencode(get_permalink($post->ID)); ?>&media=<?php echo $pinterestimage[0]; ?>&description=<?php the_title(); ?>" class="pin-it-button" count-layout="horizontal">Pin It</a>
				...
				<div class="prev-next-wrapper">
					...
					<div class="prev-post">
						...
						<?php previous_post_link('&larr; '.__('Articolo Precedente', 'mvp-text').' %link', '%title', TRUE); ?>

					</div><!--prev-post-->

					<div class="next-post">

						<?php next_post_link(''.__('Articolo Successivo', 'mvp-text').' &rarr; %link', '%title', TRUE); ?>
