    ...
    if ($tags) {
        ...
        if( $my_query->have_posts() ) { ?>
            ...
            <div id="related-posts">
            	...
            	<h4 class="post-header"><span class="post-header"><?php _e( 'Potrebbe interessarti anche...', 'mvp-text' ); ?></span></h4>
...
/* ALLUNGA IL TEMPO DEL COOKIE DI PASSWORD PROTECTED*/
function my_password_protected_auth_cookie_expiration( $seconds, $remember ) {
   if ( ! $remember ) {
      $seconds = 86400;
   }
   return $seconds;
}
//add_filter( 'password_protected_auth_cookie_expiration', 'my_password_protected_auth_cookie_expiration', 10, 2 );
